...
const placeholderImage = '/logo/logoAfc.png'; // relativ zum Webroot
...
<body>
  ...
  <main>
    <h1>${tool.name}</h1>
    <img src="${tool.image || placeholderImage}" alt="${tool.name} screenshot" class="detail-image"/>
...
async function main() {
  ...
  console.log('✅ All tools updated with screenshots and detail pages.');
}
